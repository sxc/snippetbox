...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "expires", "Expires must be equal 1, 7 or 365")
	...
	// Use Put() method to add a string value to the session data.
